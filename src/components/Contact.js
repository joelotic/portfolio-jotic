              ...
              <ul className="custom-list">
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">+65 81117077</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">joelotic@gmail.com</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">joel.198</span>
                  </h6>
                </li>
                <li>
                  <h6 className="font-weight-600">
                    ...
                    <span className="contact-content">joel.dribble</span>
                  </h6>
                </li>
              </ul>
